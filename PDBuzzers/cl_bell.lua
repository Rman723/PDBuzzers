...
-- Dont Recommend changing anything below this line --

local audioName = "DOOR_BUZZ"

local audioRef = "MP_PLAYER_APARTMENT"
    ...
    while true do 
        Citizen.Wait(0)
            ...
            if IsControlJustReleased(1, 182) then
                if GetDistanceBetweenCoords(439.07333374023, -981.12860107422, 30.689603805542, GetEntityCoords(player)) < 35 then
